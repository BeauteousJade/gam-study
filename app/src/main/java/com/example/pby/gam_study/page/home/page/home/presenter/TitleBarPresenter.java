...
public class TitleBarPresenter extends Presenter implements View.OnClickListener {
    ...
    void onRightIconClick(View view) {
        if (mGamDialogFragment == null) {
            mGamDialogFragment = new GamDialogFragment.Builder(GamDialogFragment.LocationStyle.STYLE_RIGHT_BOTTOM, R.layout.add_menu_home)
                    .setAnchorView(view)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.menu1:
                ToastUtil.info(getCurrentActivity(), "menu1");
                break;
            case R.id.menu2:
