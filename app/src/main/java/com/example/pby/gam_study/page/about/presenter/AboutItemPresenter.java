...
public class AboutItemPresenter extends Presenter implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.sure:
                mFileDownloadRequest = new FileDownloadRequest(mDownUrl, getCurrentActivity().getExternalFilesDir(Environment.DIRECTORY_DCIM) + File.separator + "new_install.apk");
