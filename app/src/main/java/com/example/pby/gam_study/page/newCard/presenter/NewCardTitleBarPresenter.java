...
import com.example.pby.gam_study.page.newCard.NewCardRequest;
import com.example.pby.gam_study.util.ToastUtil;

import butterknife.BindView;
import butterknife.OnClick;

@Module(NewCardFragment.Context.class)
public class NewCardTitleBarPresenter extends Presenter {
    ...
    private final Observer mObserver = new Observer() {
        ...
        public void onChanged(String key, Object obj) {
            switch (key) {
                case NewCardFragment.KEY_OBSERVABLE_ANSWER:
                    mAnswer = obj.toString();
                    break;
                case NewCardFragment.KEY_OBSERVABLE_OLD_IMAGE:
                    mOldImageUrl = obj.toString();
                    break;
                case NewCardFragment.KEY_OBSERVABLE_EDIT_IMAGE:
